...
class PostsList {
    ...
    func loadData(){
        ...
        let healthyPost1 = HealthyTipPost(title: "Limit your intake of foods full of saturated fats, trans fats, and dietary cholesterol.", caption: "Best Choice: Omega-3-rich fish, such as salmon, sardines, herring, mackerel, and trout. Choose at least 2 times weekly. If you’re using canned fish, such as canned sardines, select very-low-sodium or no-salt-added varieties. \n Good Choice: Most other fish, plus shelled mollusks (clams, oysters, mussels, scallops). \nSatisfactory Choices: Crustaceans (shrimp, crab, lobster, crawfish), Poultry (white meat, skinless) Game Meat (bison, venison, elk, ostrich), optimally free-range and grass-fed \nPoor Choice: Red meat (beef, pork, lamb, veal, goat). For all red meat choices, select cuts that are under 30% fat.", image: UIImage.init(named: "low-cholesterol-diet-foods")!, link: "http://hexagonbalance.weebly.com/lower-cholesterol.html")
        
        self.add(healthyPost1)
        
        let healthyPost2 = HealthyTipPost(title: "Eat a lot more fiber-rich foods.", caption: "Excellent sources include: oats, oat bran, barley, peas, yams, sweet potatoes and other potatoes, as well as legumes or beans, such as pinto beans, black beans, garbanzo beans, and peas. \n Vegetables rich in soluble fiber include: carrots, Brussels sprouts, beets, okra, and eggplant. Good fruit sources are berries, passion fruit, oranges, pears, apricots, nectarines, and apples." , image: UIImage.init(named: "Low_Cholesterol_logo")!, link: "https://www.google.ca")
